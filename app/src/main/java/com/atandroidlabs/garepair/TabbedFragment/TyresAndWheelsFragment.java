 ...
 * Use the {@link TyresAndWheelsFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class TyresAndWheelsFragment extends Fragment {
     ...
     * @return A new instance of fragment TyresAndWheelsFragment.
     */
    // TODO: Rename and change types and number of parameters
    public static TyresAndWheelsFragment newInstance(String param1, String param2) {
        TyresAndWheelsFragment fragment = new TyresAndWheelsFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        FirebaseFirestore.getInstance().collection("services").document("LzhImDCVx6jyDivEx2z6")
                .collection("Tyres and Wheels").get().addOnCompleteListener(new OnCompleteListener<QuerySnapshot>() {
            @Override
            public void onComplete(@NonNull Task<QuerySnapshot> task) {
                if (task.isSuccessful()){
                    for(QueryDocumentSnapshot document : task.getResult()){
                        ...
                        obj.setResource(R.drawable.tyre);
                        FirebaseFirestore.getInstance().collection("services").document("LzhImDCVx6jyDivEx2z6")
