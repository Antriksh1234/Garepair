 ...
 * Use the {@link PeriodicServiceFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class PeriodicServiceFragment extends Fragment {
     ...
     * @return A new instance of fragment PeriodicServiceFragment.
     */
    // TODO: Rename and change types and number of parameters
    public static PeriodicServiceFragment newInstance(String param1, String param2) {
        PeriodicServiceFragment fragment = new PeriodicServiceFragment();
            ...
            public void onComplete(@NonNull Task<QuerySnapshot> task) {
                if (task.isSuccessful()){
                    for(QueryDocumentSnapshot document : task.getResult()){
                        ...
                        obj.setResource(R.drawable.periodic);
                        FirebaseFirestore.getInstance().collection("services").document("LzhImDCVx6jyDivEx2z6")
                                .collection("Periodic Service").document(document.getId()).collection("GetPrice").get().addOnCompleteListener(new OnCompleteListener<QuerySnapshot>() {
                            @Override
